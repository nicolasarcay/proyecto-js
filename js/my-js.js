	...
	function cotizar(tipo, forma, cliente) {
	  let resultado = 0;
	...
	function onCotizar(enviar) {
	  ...
	  const total = cotizar(tipo, forma, cliente)
	  if (enviar) {
	    alert('Su pedido de cotizacion fue recibido el mismo sera enviado a su correo electronico')
	  } else {
